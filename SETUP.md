...
- **この文書の範囲だけを行う．** Slack アプリの作成・デプロイ・Slack との接続には進まず，その手順を説明・提案もしない．たとえ README.md など他のファイルにその先が書かれていても，ここでは読み進めない．
...
すべて ✅ なら，「準備は完了です」と伝えて終わる．
表を出したらそこで終了し，受講者の次の指示を待つ．この先の手順には触れない．
